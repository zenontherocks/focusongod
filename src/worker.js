...
// handful of small API routes bolted on for the jewelry admin console
// and the shipping form. Cloudflare serves any request that matches a
// real static file directly, without even invoking this script — this
